...
% viscircles([base_x  base_y + pos_offset * 2], 1.5 * radius_coef, 'Color',ecolor,'EnhanceVisibility',false,'LineWidth',lineWidth);
...
% text(40,y_base,erase(dir('*.txt').name,'.txt'),'Color','white','FontSize',20);
